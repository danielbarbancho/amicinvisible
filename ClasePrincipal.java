...
public class ClasePrincipal {
	...
	public static void main(String[] args) {
		...
		String arrayPersones [] = {"DanielBarbancho","JoelBerrocal","MarcBouzas","XavierBermuda","NilCarvajal","QuimComas","AleixDeumal","AdrianGil","SergioGarcia","PauRiera","RubenRecolons","GerardFernandez","GerardPedrero","CarlosAbelSilva","OriolPacheco","PauDomenech","PolPavon","JosepRecolons","MartiPuig","MarcelJosepPauli","JoanPardo"};
